		...
		<table class="detail">
			...
			<tr>
				<td colspan="3">
					...
					<button onclick="location.href='<%= request.getContextPath() %>/tUpView.tn?bno='+<%=t.getBno()%>">수정하기</button>
					<button onclick="location.href='<%= request.getContextPath() %>/tDelete.tn?bno='+<%=t.getBno()%>">삭제하기</button>
					<% } %>
				</td>
			</tr>
		</table>
